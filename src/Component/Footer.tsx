...
import logo from "./store/utivacolored.7364336b.svg";
      ...
      <Container>
        <Wrapper>
          <FirstDiv>
            <Logo src={logo} />
            <p>
              We are the leading TECH EDUCATION <br /> company with students from over
              30 countries <br /> and a leading UK accreditation to deliver the <br /> best
